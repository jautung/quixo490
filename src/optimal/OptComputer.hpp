...
class OptComputer {
  ...
  private:
    ...
    nsteps_t resultStepWinUpdate(nsteps_t incumResultStep, nsteps_t lossChildResultStep);
    nsteps_t resultStepLossUpdate(nsteps_t incumResultStep, nsteps_t winChildResultStep);
};
