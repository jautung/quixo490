...
CFLAGS := -g3 -Wall -std=c++11 -O3 -Xpreprocessor -fopenmp -Wno-unused-variable -Wno-unused-private-field -DOPT_COMPUTE_ERROR_CHECKING=$$OPT_COMPUTE_ERROR_CHECKING -DOPT_COMPUTE_SPEED_CHECKING=$$OPT_COMPUTE_SPEED_CHECKING -DOPT_COMPUTE_MEMORY_CHECKING=$$OPT_COMPUTE_MEMORY_CHECKING
