...
# -l 3
echo '-l 3 -X opt-steps0.0 -O random' ; ./bin/quixo $FLAGS_BASE -l 3 -X opt-steps0.0 -O random >> logs/$LOGFILE
echo '-l 3 -X opt-steps0.0 -O heuris-simple' ; ./bin/quixo $FLAGS_BASE -l 3 -X opt-steps0.0 -O heuris-simple >> logs/$LOGFILE
...
echo '-l 3 -X opt-steps0.0 -O opt-steps0.0' ; ./bin/quixo $FLAGS_BASE -l 3 -X opt-steps0.0 -O opt-steps0.0 >> logs/$LOGFILE
echo
echo '-l 3 -O opt-steps0.0 -X random' ; ./bin/quixo $FLAGS_BASE -l 3 -O opt-steps0.0 -X random >> logs/$LOGFILE
echo '-l 3 -O opt-steps0.0 -X heuris-simple' ; ./bin/quixo $FLAGS_BASE -l 3 -O opt-steps0.0 -X heuris-simple >> logs/$LOGFILE
...
# -l 4
echo '-l 4 -X opt-steps0.0 -O random' ; ./bin/quixo $FLAGS_BASE -l 4 -X opt-steps0.0 -O random >> logs/$LOGFILE
echo '-l 4 -X opt-steps0.0 -O heuris-simple' ; ./bin/quixo $FLAGS_BASE -l 4 -X opt-steps0.0 -O heuris-simple >> logs/$LOGFILE
...
echo '-l 4 -X opt-steps0.0 -O opt-steps0.0' ; ./bin/quixo $FLAGS_BASE -l 4 -X opt-steps0.0 -O opt-steps0.0 >> logs/$LOGFILE
echo
echo '-l 4 -O opt-steps0.0 -X random' ; ./bin/quixo $FLAGS_BASE -l 4 -O opt-steps0.0 -X random >> logs/$LOGFILE
echo '-l 4 -O opt-steps0.0 -X heuris-simple' ; ./bin/quixo $FLAGS_BASE -l 4 -O opt-steps0.0 -X heuris-simple >> logs/$LOGFILE
